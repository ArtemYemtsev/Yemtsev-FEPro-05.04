...
let userPhones = [];
    users.filter(balanceFilter).forEach(obj => {
        return userPhones.push(obj.phone);
    });

// Вывод массива телефоных номеров пользователей, у которых баланс больше 2000 доларов
